        ...
        <div className="bg-gray-900 rounded-2xl p-6 border border-gray-800">
          ...
          <div className="mt-6">
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              <button
                type="button"
                className="w-full bg-gray-800 border border-gray-600 text-white py-3 rounded-lg font-medium hover:bg-gray-700 active:scale-95 transition-all flex items-center justify-center gap-2"
              >
